...
try {
  ...
  $response = $fb->get(
    'act_2212482835703434?fields=adsets.limit(100){name,lifetime_budget,budget_remaining,end_time,start_time,campaign{adlabels},id,campaign_id,account_id,created_time,configured_status,effective_status,status,ads{adcreatives{effective_object_story_id}}}',
    $token
  );
